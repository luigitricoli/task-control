...
<div id="add-task-container" class="float-window addTaskWindow">
    <form id="add-task-form">
        ...
        <div class="field repeat-field">
            ...
            <span class="label">Repeat for:</span>
        ...
        <div class="field btn-container">
            <button type="reset" id="cancel-register-btn" class="btn red"><span class="icon add">X</span>Cancel</button>
            <button type="button" id="salve-register-btn" class="btn green"><span class="icon add">V</span>Save</button>
        </div>
    </form>
</div>
