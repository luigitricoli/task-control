...
public class FinishedSpliterTest {
    ...
    public void moreThaOneWeekTaskFinishedEarlyInSecondWeek() throws ParseException {
        ...
        TaskSpliter spliter = new FinishedSpliter();
    ...
    public void oneWeekTaskFinishedLate() throws ParseException {
        String json = "{\"id\":\"52f518377cf06f3be158a352\",\"description\":\"My First CoreTask\",\"startDate\":\"2014-02-17\",\"endDate\":\"2014-02-20\",\"foreseenEndDate\":\"2014-02-19\",\"source\":\"CCC\",\"application\":\"OLM\",\"owners\":[{\"login\":\"john\"},{\"login\":\"mary\"}],\"posts\":[{\"timestamp\":\"2014-01-03 09:15:30\",\"user\":\"john\",\"text\":\"Scope changed. No re-scheduling will be necessary\"},{\"timestamp\":\"2014-01-08 18:20:49\",\"user\":\"john\",\"text\":\"Doing #overtime to finish it sooner\"}]}";

        TaskSpliter spliter = new FinishedSpliter();
        spliter.split(CoreTask.unmarshal(json));

        OneWeekTask expected = new OneWeekTask("52f518377cf06f3be158a352", 2, 4, 4, Stage.FINISHED, "My First CoreTask", new HashMap<Integer, Hashtags>());
        assertThat(spliter.fourthWeek(), equalTo(expected));
    }
    ...
    public void moreThaOneWeekTaskFinishedLate() throws ParseException{
        ...
        OneWeekTask first = new OneWeekTask("52f518377cf06f3be158a352", 4, 3, 3, Stage.FINISHED, "My First CoreTask", new HashMap<Integer, Hashtags>());
        OneWeekTask second = new OneWeekTask("52f518377cf06f3be158a352", 2, 2, 2, Stage.FINISHED, "My First CoreTask", new HashMap<Integer, Hashtags>());
