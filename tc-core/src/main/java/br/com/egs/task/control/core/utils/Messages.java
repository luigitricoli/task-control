...
public class Messages {
    ...
    public static enum Keys {
        ...
        VALIDATION_TASK_YEAR_AND_MONTH_USE_BOTH,
        VALIDATION_TASK_DAY_INTERVAL_USE_BOTH,
        VALIDATION_TASK_YEAR_OR_MONTH_INVALID,
        VALIDATION_TASK_INVALID_SEARCH_DATE,
        VALIDATION_TASK_INVALID_SEARCH_DATE_BEGIN_AFTER_END,
        VALIDATION_TASK_SEARCH_INTERVAL_REQUIRED,
